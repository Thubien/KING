                    ...
                    Tables\Columns\Layout\Split::make([
                        ...
                        Tables\Columns\Layout\Stack::make([
                            ...
                            Tables\Columns\TextColumn::make('last_sync_at')
                                ->label('Last Sync')
                                ->since()
                                ->color(fn (Store $record) => $record->last_sync_at && $record->last_sync_at->diffInHours(now()) > 2
                                        ? 'warning'
                                        : 'success'
                                )
                                ->icon(fn (Store $record) => $record->last_sync_at && $record->last_sync_at->diffInHours(now()) > 2
